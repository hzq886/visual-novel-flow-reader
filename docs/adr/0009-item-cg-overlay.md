...
- ステータス: 採択（2026-07-05）
- 関連: [0002 データスキーマ](0002-data-schema.md) / [0005 フロー復元](0005-flow-reconstruction.md) / [`smain_flow_guide.md` §3.12](../../data_extract/text/_tools/smain_flow_guide.md)（HU-70）
